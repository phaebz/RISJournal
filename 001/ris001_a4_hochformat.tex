...
% \setlength\headsep{0pt} % Top margin
% \setlength\headheight{0pt} % Header height
% \setlength\textwidth{7.0in} % Text width
% \setlength\textheight{9.5in} % Text height
% \setlength\oddsidemargin{2cm} % Left margin
% \setlength\evensidemargin{2cm} % Left margin (even pages) - only relevant with 'twoside' article option
% \setlength\inner{4cm}
% \setlenfth\outer{2cm}
\usepackage[outermargin=6cm,
			innermargin = 2.5cm,
			top=2cm,
