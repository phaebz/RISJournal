...
\textbf{R}emix \textbf{I}mprove \textbf{S}hare - das freie, creative-commons lizensierte Journal zu den Themen Open-Source, Spiele Programmierung, Open Education. Preis: Zahlen Sie so viel Sie wollen (siehe Bitcoin- und Flattr QR-Code).
...
\begin{multicols}{3}
\NewsItem{}
\input{editoral/editoral} %spellecheck, Schule, hardware, Linux, Gramlich
%\includegraphics[width=0.8\linewidth]{editoral-freiesoftware.png}
\end{multicols}
%\begin{center}
%\includegraphics[width=0.8\linewidth]{editoral-freiesoftware.png}
%\end{center}
...
%-----------------------------------------------------------
%\begin{center}
%\includegraphics[width=14cm]{austrianguy.png} \\
...
\end{multicols}
% lama einfügen zentriert auf ganze Seite
%
%\begin{center}
%\includegraphics[width=0.6\linewidth]{olpcnewyear/olpclama.jpg}\\
%\footnotesize{Christoph Derndofer (im Bild links) in Peru mit XO Laptop. cc-by-sa, [2]}
%\end{center}
%\SepRule{}
%-----------------------------------------------------------
\newpage
...
%\newpage
\begin{multicols}{2}
\input{powdertoy/powdertoypictures}
\end{multicols}
%\SepRule
%-----------------------------------------------------------
\newpage  % 2 Spaltig
