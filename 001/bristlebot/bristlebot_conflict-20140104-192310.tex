...
\textbf{\href{http://www.evilmadscientist.com/about/}{Windell "Evil Mad Chief Scientist" Oskay} [1] zeigt in diesem Tutorial wie man Roboter aus Zahnbürsten baut, so genannte \textit{Bristlebots}}

Der englischsprachige Original Artikel ist copyright-geschützt von Windell Oskay [1] und erschien erstmals am 19.12.2007 auf seiner Homepage [2]. Übersetzung von Horst JENS [3] mit freundlicher Genehmigung des Autors.

\begin{center}
\includegraphics[width=5cm]{bristlebot-evilmadscientist.jpg}\\
\footnotesize{Windell Oskay, Ph.D. Bildrechte: [1]}
\end{center}

Der Zahnbürstenroboter (BristleBot) ist ein einfacher, kleiner, emsiger Roboter. Zutaten: Eine Zahnbürste, eine Batterie, und ein Vibrationsmotor. Das Resultat kann man \href{http://youtu.be/rUSTXUis_ys}{auf Youtube bewundern} [4].

\begin{center}
\includegraphics[width=5cm]{bristlebot1.jpg}\\
\footnotesize{Bristlebot. Bildrechte: [1]}
\end{center}

Der BristleBot ist unser Versuch einen \href{http://makezine.com/projects/make-10/vibrobots/}{\textit{Vibrobot}} [5] zu bauen: primitive Roboter die durch einen einzigen Vibrations(Exzentrik)-Motor bewegt werden. Sehenswerte Varianten davon sind z.B. der mint-tin (siehe Make Magazin) und der \href{http://www.finkbuilt.com/blog/kids-art-bot/}{Kid's draw bot} [6]: ein Vibrobot mit Beinen aus Bleistiften. \\
 
\begin{center}
\includegraphics[width=5cm]{bristlebot2.jpg}\\
\includegraphics[width=5cm]{bristlebot3.jpg}\\
...
\begin{center}
\includegraphics[width=5cm]{bristlebot4.jpg}\\
\includegraphics[width=5cm]{bristlebot5.jpg}\\
...
\\
\begin{center}
\includegraphics[width=5cm]{bristlebot6.jpg}\\
\includegraphics[width=5cm]{bristlebot7.jpg}\\
...
\begin{center}
\includegraphics[width=5cm]{bristlebot8.jpg}\\
\includegraphics[width=5cm]{bristlebot9.jpg}\\
...
\begin{center}
\includegraphics[width=5cm]{bristlebot11.jpg}\\
\includegraphics[width=5cm]{bristlebot13.jpg}\\
...
\
\begin{center}
\includegraphics[width=5cm]{bristlebot14.jpg}
...
\includegraphics[width=3cm]{ccbysa88x31.png}
\end{wrapfigure}
